...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-emerald-600 text-sm font-medium leading-5 text-emerald-600 focus:outline-hidden focus:border-emerald-700 transition duration-150 ease-in-out'
